...
CVE_DIR = "cvelistV5"
OUTPUT_DIR = "socials_pipeline\data\catalogs"
...
def merge_and_enrich_catalogs(
    ...
    output_csv="{OUTPUT_DIR}/enriched_catalog.csv"
):
...
def merge_social_media_with_catalog(
    cve_catalog_path='socials_pipeline/data/catalogs/enriched_catalog.csv',
    mastodon_path='socials_pipeline/data/mastodon/mastodon_catalog.csv',
    reddit_path='socials_pipeline/data/reddit/reddit_catalog.csv',
    mastodon_output_path='socials_pipeline/parquet_inputs/merged_mastodon.csv',
    reddit_output_path='socials_pipeline/parquet_inputs/merged_reddit.csv'
):

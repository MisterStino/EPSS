...
Usage:
    python merge_features.py --source github --input-file github_commit_timestamps_9k.csv
    python merge_features.py --source reddit --input-file reddit_features.parquet
"""
